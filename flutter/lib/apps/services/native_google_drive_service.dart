...
/// Service for handling native Google Sign-In for Google Drive integration
/// This bypasses the web OAuth flow and uses native Google Sign-In instead
class NativeGoogleDriveService {
  static final NativeGoogleDriveService _instance =
      NativeGoogleDriveService._internal();
  static NativeGoogleDriveService get instance => _instance;

  NativeGoogleDriveService._internal();

  factory NativeGoogleDriveService() => _instance;
  ...
  /// Connect to Google Drive using native Google Sign-In
  /// Returns the connection details if successful
  Future<GoogleDriveConnection> connectWithNativeSignIn() async {
    ...
    try {
      ...
      final response = await _apiClient.post(
        '/workspaces/$workspaceId/google-drive/connect-native',
        data: {
      ...
      if (data is Map<String, dynamic>) {
        return GoogleDriveConnection.fromJson(data);
      }
      ...
      throw Exception(
        e.response?.data?['message'] ??
            'Failed to connect Google Drive with native sign-in',
      );
    } catch (e) {
