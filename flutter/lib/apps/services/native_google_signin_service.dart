...
/// Service for handling native Google Sign-In for Google Sheets integration
/// This bypasses the web OAuth flow and uses native Google Sign-In instead
/// Uses google_sign_in 7.x API
class NativeGoogleSignInService {
  static final NativeGoogleSignInService _instance =
      NativeGoogleSignInService._internal();
  static NativeGoogleSignInService get instance => _instance;

  NativeGoogleSignInService._internal();

  factory NativeGoogleSignInService() => _instance;
  ...
  /// Connect to Google Sheets using native Google Sign-In
  ...
  Future<GoogleSheetsConnection> connectWithNativeSignIn() async {
    ...
    try {
      ...
      final response = await _apiClient.post(
        '/workspaces/$workspaceId/google-sheets/connect-native',
        data: {
      ...
      throw Exception(
        e.response?.data?['message'] ??
            'Failed to connect Google Sheets with native sign-in',
      );
    } catch (e) {
