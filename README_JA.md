...
5. **AIで自動化** — AutoPilotはアプリ全体にフルアクセスでき、スケジューリング、メッセージ、プロジェクト更新など、あらゆることを自動化できます
6. **スマート提案を取得** — AIがデータを分析し、ダッシュボードからタスク、アクション、優先事項を提案します
...
- **🤖 AutoPilot AIエージェント** — アプリ全体にアクセスできる完全自律型AIアシスタント — タスクの自動化、会議のスケジューリング、メッセージの送信、プロジェクトの管理、すべてのモジュールにわたるワークフローの処理
- **🧠 スマート提案** — アクティビティ、プロジェクト、締め切りを分析してタスクと優先事項を推奨するAI駆動のダッシュボード提案
- **🧰 組み込みツール** — 日常タスク用のすぐに使える生産性ツール — 投票、リマインダー、時間追跡、テンプレートなど — セットアップ不要
- **🔌 コネクタ** — Slack、Googleドライブ、GitHub、Dropbox、Gmailなど、6つ以上の事前接続OAuth統合を含む180以上のサードパーティアプリコネクタ
...
<p align="center">
  <strong>🤖 AutoPilot AIエージェント</strong><br>
  <em>アプリ全体にアクセスできる完全自律型AIアシスタント — 何でも聞いて、すべてを自動化</em><br><br>
  <img src="docs/autopilot.png" alt="AutoPilot AI Agent" width="800">
</p>

<p align="center">
  <strong>🧠 スマート提案</strong><br>
  <em>AIがアクティビティと締め切りを分析し、ダッシュボードからタスクと優先事項を推奨</em><br><br>
  <img src="docs/suggestions.png" alt="Smart Suggestions Dashboard" width="800">
</p>

<p align="center">
  <strong>🧰 組み込みツール</strong><br>
  <em>すぐに使える生産性ツール — ドキュメントビルダー、ボット、予算、ホワイトボード、フォームなど</em><br><br>
  <img src="docs/tools.png" alt="Built-in Tools" width="800">
</p>

<p align="center">
  <strong>🔌 コネクタ</strong><br>
  <em>Gmail、Googleカレンダー、ドライブ、GitHub、Dropboxなどの事前接続OAuth付き180以上のサードパーティアプリコネクタ</em><br><br>
...
- ✅ **AI AutoPilot** — アプリ全体にアクセスできる完全自律型AIエージェントによるエンドツーエンドのタスク自動化
- ✅ **スマート提案** — ユーザーデータを分析してタスクと優先事項を推奨するAI駆動ダッシュボード
- ✅ **180+コネクタ** — Slack、GitHub、Google、その他の事前接続OAuthを備えたサードパーティアプリ統合
- ✅ **多言語サポート** — 英語と日本語のi18n
...
| **生産性** | カレンダー（イベント、会議室）、フォーム（ビルダー、分析）、承認（ワークフロー）、予算（経費、請求）、組み込みツール（投票、リマインダー、テンプレート） |
| **AI＆自動化** | AutoPilot（アプリ全体の自律型エージェント）、スマート提案（AIタスク推奨）、会議インテリジェンス、ドキュメント分析、ボット（トリガー、アクション、スケジューリング） |
| **プラットフォーム** | 認証（OAuth、SSO）、ワークスペース管理、ロール＆権限、検索（セマンティック）、分析、180+コネクタ（Slack、GitHub、Google、Dropboxなど） |
