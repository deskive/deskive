 ...
 * tiny — the module factory in `auth.module.ts` provides a default
 * implementation that delegates to `database/email-helpers.ts`, but
 * tests (and the smoke-test script) can inject any implementation
 * with this shape.
 */
